...
> in the platform routing section of `PLATFORM_SETUP.md` — this file is evidence, not policy.
...
|---|---|---|---|---|---|
| 2026-08-12 | bulk-extract (example) | [configured model] | low | N | 34 receipts parsed, spot-check clean — delete this row |
