...
For root checks use that workspace; for loading-nested also copy the AI-ASSISTANT template to a
separate scratch workspace. Preserve its relative directory layout.
