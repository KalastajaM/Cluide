...
Scratch space: drafts, intermediate files, half-finished analysis, anything in progress. Kept
separate from `Outputs/` so that nothing unfinished is ever mistaken for a deliverable.
