# Decision Tracker – [PLACEHOLDER: Initiative Name]

**Owner:** [PLACEHOLDER: Initiative Owner Name] | **Sponsor:** [PLACEHOLDER: Workstream Sponsor Name] | **Last updated:** [PLACEHOLDER: YYYY-MM-DD] (rev 1 — initial template)

**Purpose:** Central register of all programme-level decisions — strategic, commercial, product/technical, and financial. Each record captures what was decided, who decided it, when, why, and what it affects. Update this register whenever a new decision is made, an existing decision is revised, or a decision is superseded.
...
| Status | Meaning |
|---|---|
| ✅ Confirmed | Decision is final and in effect |
| 🔄 In Progress | Decision made in principle; execution/formalisation ongoing |
| ⏳ Pending | Decision not yet made |
| ⚫ Superseded | Decision overridden by a later decision |
