# [PLACEHOLDER: Initiative Name] — Action Tracker
...
> **On duplication:** Actions already tracked in detail in a `Knowledge_Base.md` section are listed here as reference entries (marked **→ ref**) with a pointer to the source rather than being duplicated. All other actions are fully described here.
...
| Status | Meaning |
|---|---|
| 🔴 Open | Action is open; no progress yet |
| 🔄 In progress | Action is actively being worked on |
| ⏳ Blocked / Awaiting | Action is blocked or awaiting input from another party |
| 🟡 Monitoring | Action is under observation; no immediate step required |
| 💤 Snoozed | Action is deprioritized; revisit later |
...
| Code | Category |
|---|---|
| PJ | Project (plan, structure, governance) |
| P | Product (feature, R&D dependency, technical) |
| C | Commercial (pricing, partner, contracts) |
| O | Operational (process, tooling, people) |
| F | Financial (model, data, analysis) |
| D | Decision (pending decision required) |
...
**Action:** [PLACEHOLDER: Full action description — e.g. "Review programme registers (Risk, Action, Dependency) and provide feedback on completeness and accuracy."]
**Owner:** [PLACEHOLDER: Owner(s)] | **Due:** [PLACEHOLDER: Due date or frequency — e.g. "Weekly"] | **Status:** 🔄 In progress | **Category:** Project | **Source:** —

[PLACEHOLDER: Additional context if needed. Delete this line if not required.]
...
| Rev | Date | Change |
|---|---|---|
| 1 | [PLACEHOLDER: YYYY-MM-DD] | Initial tracker created from template |
