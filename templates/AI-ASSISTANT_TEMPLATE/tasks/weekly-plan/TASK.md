...
- **[YOUR_FOCUS_BLOCK]** (e.g. an early-morning standing block): available for deep work if a long block is needed
- **[YOUR_LUNCH_BLOCK]**: skip as a scheduling target
- **[YOUR_END_OF_DAY_MARKER]**: treat as the end of the productive day

List your own standing blocks here. If you have none, delete this paragraph.
...
**Avoid [YOUR_BUSIEST_WEEKDAY]** unless there is a hard deadline — name here whichever weekday your calendar is reliably packed with recurring meetings.
