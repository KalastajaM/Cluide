...
Read `../../AGENTS.md` before this task. Resolve paths in this file relative to its own folder. All project-level context (user identity, communication style, critical rules, business context, profile/knowledge/actions file map) is in `../../AGENTS.md`.
