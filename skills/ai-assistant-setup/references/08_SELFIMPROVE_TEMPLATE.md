...
The template lives at `templates/TASK_TEMPLATE/IMPROVEMENTS.md` in the Cluide repo. It is ready to copy into any task folder and use from run 1. (Not bundled with this skill — fetch from the source repository.)
