...
**Caveat:** these are research-preview features whose names and availability change between releases — verify in your version (`/help`, [code.claude.com/docs](https://code.claude.com/docs)) before relying on them. `ultracode`, `/workflows`, and `/goal` are confirmed current as of August 2026; the others may differ.
